  ...
  <div className="flex items-center justify-center flex-1 px-4">
    <div className="w-full max-w-3xl mx-auto text-center">
      <h1 className="mb-4 text-6xl font-bold text-transparent uppercase bg-gradient-to-r from-orange-500 to-red-600 bg-clip-text">
        <span className="text-white">EMSD</span> Radio Diagnostics
      </h1>
      <p className="w-2/3 mx-auto mb-6 text-lg text-gray-400">
        Welcome to EMSD's radio machine diagnostics platform. Ask questions about your radio equipment, troubleshooting, or technical specifications.
      </p>
      <form onSubmit={handleSubmit}>
        <div className="relative max-w-xl mx-auto">
          <textarea
            ...
            placeholder="Describe your radio machine issue or ask a technical question..."
