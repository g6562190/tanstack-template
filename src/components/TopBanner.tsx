...
export function TopBanner() {
  ...
  return (
    <div className="relative w-full max-w-3xl px-2 py-2 mx-auto mt-4 mb-2 font-medium text-white bg-orange-500 rounded-md text-sm">
      ...
      <p className='px-4'>This EMSD diagnostics chat works with <a href='https://docs.netlify.com/build/ai-gateway/overview/' className='underline'>Netlify AI Gateway</a>. For custom configuration, update <a href='https://docs.netlify.com/build/environment-variables/overview/' className='underline'>the environment variables</a> in your project.</p>
    </div>
  );
}
